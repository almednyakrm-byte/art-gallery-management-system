...
<body class="h-screen bg-gray-200 flex justify-center items-center">
    <div class="bg-white p-10 rounded shadow-md w-1/2">
        <h2 class="text-3xl text-amber-400 mb-4">Register</h2>
        <form id="register-form">
            ...
            <button type="submit" class="bg-amber-400 hover:bg-amber-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Register</button>
        </form>
        ...
        $(document).ready(function() {
            $('#register-form').submit(function(e) {
                ...
                if (username === '' || email === '' || password === '') {
                    $('#register-response').html('<div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert"><span class="block sm:inline">Please fill in all fields.</span></div>');
                    return;
                }
