...
if (!isset($_GET['id'])) {
    header('Location: list_exhibitions.php');
    exit;
}
...
<body>
    <div class="container mx-auto p-4 pt-6 mt-10 bg-gray-200 rounded-lg shadow-md">
        <h2 class="text-2xl font-bold text-amber-400 mb-4">Edit Exhibition</h2>
        <form id="edit-exhibition-form">
            <div class="mb-4">
            ...
            <button type="submit" class="bg-amber-400 hover:bg-amber-500 text-gray-200 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Update Exhibition</button>
        </form>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '../backend/exhibitions.php?id=' + id,
                dataType: 'json',
            ...
            $('#edit-exhibition-form').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    data: formData,
                    success: function(data) {
                        window.location.href = 'list_exhibitions.php';
                    }
                });
            });
        });
