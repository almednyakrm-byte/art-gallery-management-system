...
<body class="bg-slate-900 text-white">
    ...
    <main class="container mx-auto p-4 pt-6 md:p-6 lg:p-12 xl:p-24">
        <h1 class="text-3xl font-bold mb-4">فنانين</h1>
        <div class="flex justify-between mb-4">
            <button class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
                <a href="create_فنانين.php">Add New Item</a>
            </button>
            <input type="text" id="search" class="bg-slate-800 text-white font-bold py-2 px-4 rounded" placeholder="Search...">
        </div>
        <table class="table-auto w-full text-white" id="table">
            ...
            .then(data => {
                ...
                data.forEach(item => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="px-4 py-2">
                            <a href="edit_فنانين.php?id=${item.id}" class="text-indigo-500 hover:text-indigo-700">Edit</a>
